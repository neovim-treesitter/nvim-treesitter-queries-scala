...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-scala/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-scala/actions/workflows/validate.yml)

Neovim tree-sitter queries for **scala**, part of the
...
- [ ] Changes are scoped to `scala` — do not include files for other languages
